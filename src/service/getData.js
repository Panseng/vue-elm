...
//  获取msite商铺列表
export const shopList = (latitude, longitude, offset, restaurant_categor_id = '', restaurant_categor_ids = '', order_by = '', delivery_mode = '', support_ids = []) => {
  let supportStr = ''
  ...
  let data = {
    ...
    'extras[]': 'activities',
    keyword: '',
    restaurant_categor_id,
    'restaurant_category_ids[]': restaurant_categor_ids,
    order_by,
