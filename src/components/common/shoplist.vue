...
export default {
  ...
  props: [
    'restaurantCategroyId',
    'restaurantCategroyIds',
    'sortByType',
    'deliveryMode',
    'supportIds',
    'confirmSelect',
  ...
  methods: {
    async initData () {
      // 获取数据
      let res = await shopList(this.latitude, this.longitude, this.offset, this.restaurantCategroyId)
  ...
  watch: {
    restaurantCategroyIds: function (value) {
